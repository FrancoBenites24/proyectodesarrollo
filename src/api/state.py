...
class AppState:
    ...
    async def _detection_loop(self) -> None:
        from src.api.routes.ws import broadcast_metrics
        ...
        while self.is_running:
            ...
            events = classify_event(result, temporal_state)
            state = TemporalState(
            ...
            self.last_metrics = DrowsinessMetrics(
                ...
                driving_minutes=round(self.driving_timer.elapsed_minutes, 1),
            ...
            await broadcast_metrics(self.last_metrics.model_dump())
